...
export type Scalars = {
  ...
  EmailString: { input: string; output: string }
...
export type SiteSubscriptionInfoQuery = {
  __typename?: 'Query'
...
export type TrackSubscriberActivityMutation = { __typename?: 'Mutation'; trackSubscriberActivity: boolean }

export const SignInPaywallDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'SignInPaywall' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'email' } },
          type: { kind: 'NonNullType', type: { kind: 'NamedType', name: { kind: 'Name', value: 'EmailString' } } },
        },
      ],
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'signInLeakySubscriber' },
            arguments: [
              {
                kind: 'Argument',
...
} as unknown as DocumentNode<SignInPaywallMutation, SignInPaywallMutationVariables>
export const SiteSubscriptionInfoDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'SiteSubscriptionInfo' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
...
} as unknown as DocumentNode<SiteSubscriptionInfoQuery, SiteSubscriptionInfoQueryVariables>
export const TrackSubscriberActivityDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'TrackSubscriberActivity' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          ...
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'TrackSubscriberActivityInput' } },
          },
        },
      ],
      selectionSet: {
...
} as unknown as DocumentNode<TrackSubscriberActivityMutation, TrackSubscriberActivityMutationVariables>
